# BuyPlux Database : Developed a relational database for BuyPlux Multiresources Limited that allows them to capture and store all of the key information and data generated by the business 
